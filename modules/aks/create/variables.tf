...
variable "acr_names" {
  type        = list(string)
  description = "List of acr repository"
}

variable "streams" {
  description = "Various streams of logs to be ingested in container insights"
  type = list(string)
