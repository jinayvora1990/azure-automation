...
| <a name="input_data_collection_interval"></a> [data\_collection\_interval](#input\_data\_collection\_interval) | data\_collection\_interval | `string` | `"1m"` | no |
...
| <a name="input_enableContainerLogV2"></a> [enableContainerLogV2](#input\_enableContainerLogV2) | Boolean parameter to enable container logs | `bool` | `true` | no |
...
| <a name="input_namespace_filtering_mode_for_data_collection"></a> [namespace\_filtering\_mode\_for\_data\_collection](#input\_namespace\_filtering\_mode\_for\_data\_collection) | namespace\_filtering\_mode\_for\_data\_collection | `string` | `"Off"` | no |
| <a name="input_namespaces_for_data_collection"></a> [namespaces\_for\_data\_collection](#input\_namespaces\_for\_data\_collection) | Namespace for data collection | `list(string)` | <pre>[<br>  "kube-system",<br>  "gatekeeper-system",<br>  "azure-arc"<br>]</pre> | no |
